        ...
        <div class="footer__list">
         ...
         <div class="footer__copyright row">
          <div class="twelve columns">
            <p>Copyright &copy; <?php echo date('Y'); ?> PSS. All rights reserved
            <p style="text-align: right; padding-right: 15px">Proudly donated by Michał Kolek <a href="http://www.WebServiceDev.co.uk" alt="link do www.webservicedev.co.uk">www.WebServiceDev.co.uk</a></p>
          </div></div>
        </footer>
